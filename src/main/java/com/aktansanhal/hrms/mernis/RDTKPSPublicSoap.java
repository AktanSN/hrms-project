...
public class RDTKPSPublicSoap
{
    ...
    public RDTKPSPublicSoap(){}

    public RDTKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RDTKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RDTExtendedSoapSerializationEnvelope envelope= new RDTExtendedSoapSerializationEnvelope(RDTExtendedSoapSerializationEnvelope.VER11);
