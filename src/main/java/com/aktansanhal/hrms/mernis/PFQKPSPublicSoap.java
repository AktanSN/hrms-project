...
public class PFQKPSPublicSoap
{
    ...
    public PFQKPSPublicSoap(){}

    public PFQKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public PFQKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        PFQExtendedSoapSerializationEnvelope envelope= new PFQExtendedSoapSerializationEnvelope(PFQExtendedSoapSerializationEnvelope.VER11);
